...
def infer(image, model, device, detection_threshold):
    """
    Predict the output of an image after forward pass through
    the model and return the bounding boxes, keypoints, class names, scores, and
    class labels.
    """
    ...
    labels = outputs[0]["labels"][: len(boxes)].cpu().numpy()
